<div class="row">
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0">Edit Location: <?= htmlspecialchars($location['name']) ?></h4>
            </div>
            <div class="card-body">
                <form method="POST" action="/admin/tryout-locations/update">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="street_address" name="street_address" required
                               value="<?= htmlspecialchars($location['street_address']) ?>"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control" id="state" name="state" required
                                   value="<?= htmlspecialchars($location['state']) ?>"
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" id="zip_code" name="zip_code" required
                                   value="<?= htmlspecialchars($location['zip_code']) ?>"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control" id="map_link" name="map_link"
                               value="<?= htmlspecialchars($location['map_link'] ?? '') ?>"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="special_instructions" name="special_instructions" rows="4"
                                  placeholder="Parking information, gate codes, check-in location, etc."><?= htmlspecialchars($location['special_instructions'] ?? '') ?></textarea>
    ...
    <div class="col-md-4">
        <div class="card bg-light mb-3">
            <div class="card-body">
                <h5 class="card-title"><i class="bi bi-info-circle"></i> Location Info</h5>
                <dl class="row mb-0 small">
                    <dt class="col-sm-5">Created:</dt>
                    <dd class="col-sm-7"><?= date('M j, Y', strtotime($location['created_at'])) ?></dd>
        ...
        <div class="card bg-light">
            <div class="card-body">
                ...
                <ul class="small mb-0">
                    ...
                    <li>Keep address information accurate for GPS</li>
                    <li>Update special instructions for seasonal changes</li>
                    <li>Deactivate locations that are no longer in use</li>
                </ul>
            </div>
        </div>
    </div>
